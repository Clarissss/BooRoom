...
Future<void> _loadData() async {
  ...
  try {
    String response = await ds.selectAll(token, project, 'pending_booking', appid);
...
void _updateStatus(int index, String newStatus,{String reason = ''}) async {
  ...
  String statCancel = 'Rejected By Biro Akademik';
  String statApprove = 'Approved by Biro Akademik';
