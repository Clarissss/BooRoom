...
import 'package:bookingroom/utils/pending_booking_fakultas.dart';
...
class ManageProspectFakultasPage extends StatefulWidget {
  @override
  _ManageProspectFakultasPageState createState() =>
      _ManageProspectFakultasPageState();
}

class _ManageProspectFakultasPageState
    extends State<ManageProspectFakultasPage> {
  List<PendingBookingFakultasModel> _prospects = [];
  List<BookingModel> _bookings = [];
  List<PendingBookingFakultasModel> _filteredProspects = [];
  ...
  Future<void> selectAllSchedule() async {
    try {
      String response =
          await ds.selectAll(token, project, 'pending_booking_fakultas', appid);
      List<dynamic> data = jsonDecode(response);
      setState(() {
        _prospects =
            data.map((e) => PendingBookingFakultasModel.fromJson(e)).toList();
