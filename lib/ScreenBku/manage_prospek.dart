...
class _ProspectPageState extends State<ProspectPage> {
  ...
  List<PendingBookingBkuModel> _filteredProspects = [];
  ...
  Future<void> selectAllSchedule() async {
    try {
      String response =
          await ds.selectAll(token, project, 'pending_booking_bku', appid);
      List<dynamic> data = jsonDecode(response);
      setState(() {
        _prospects =
            data.map((e) => PendingBookingBkuModel.fromJson(e)).toList();
